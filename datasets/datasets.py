...
class Action_DATASETS(data.Dataset):
    def __init__(self, root, list_file, labels_file, description_file,
    ...
    def _load_image(self, directory, idx):
        return [Image.open(os.path.join(self.root, directory, self.image_tmpl.format(idx))).convert('RGB')]
    ...
    def descriptions(self):
        descriptions = pd.read_csv(self.description_file)
